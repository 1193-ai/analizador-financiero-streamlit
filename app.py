...
if uploaded_file:
    ...
    # Detectar si los conceptos están en filas (vertical)
    if "Concepto" in df_raw.columns:
        df = df_raw.set_index("Concepto").T  # Transponer para trabajar como si fueran columnas
